...
@section('title', 'Unapproved Investee')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Unapproved Investees</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item active">Manage-Investees</li>
            <li class="breadcrumb-item active">Unapproved-Investees</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="card-title">Unapproved Investees Table</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        @foreach($investees as $investee)
                            <tr>
                                ...
                                <td>
                                <form action="{{ route('investee.approve', $investee->id) }}" method="post">
                                              {{ csrf_field() }}
                                              {{ method_field('put') }}
