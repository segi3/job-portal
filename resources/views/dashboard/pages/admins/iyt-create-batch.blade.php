...
@section('title', 'IYT Create Batch')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Create IYT Batch</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item active">Manage-IYT</li>
            <li class="breadcrumb-item active">Create IYT Batch</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    @if (Session::has('success'))
			...
			@endif
    <div class="container-fluid">
        <form method="POST" role="form" id="quickForm" enctype="multipart/form-data" action="{{ route('iyt.createBatch') }}">
        @csrf
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Create Batch/Open Registration for IYT</h3>
                    </div>
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="start_date" placeholder="dd-mm-yyyy"
                            value="{{ old('star_tdate') }}" onfocus="this.placeholder = ''"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="end_date" placeholder="dd-mm-yyyy"
                            value="{{ old('end_date') }}" onfocus="this.placeholder = ''"
                            onblur="this.placeholder = 'dd-mm-yyyy'" required
                            class="single-input form-control datepicker" autocomplete="off">
                    </div>
                    </div>
