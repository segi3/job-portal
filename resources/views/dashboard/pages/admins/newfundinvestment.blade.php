...
@section('title', 'New Funding Investment')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">New Funding Investment</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item active">Manage-Funding-Investment</li>
            <li class="breadcrumb-item active">New-Funding-Investment</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="card-title">New Funding Investment Table</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        @foreach($investasi as $invest)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('proposal.funding.investasi.download', $invest->id) }}" method="get">
                                      <button type="submit" class="btn btn-sm btn-block btn-primary mr-4">Download</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="{{ route('laporan.funding.investasi.download', $invest->id) }}" method="get">
                                      <button type="submit" class="btn btn-sm btn-block btn-primary mr-4">Download</button>
                                    </form>
                                </td>
                                ...
                                <td>
                                    <div class="row">
                                      <div class="col-lg-6">
                                          <form action="{{ route('funding.investment.approve', $invest->id) }}" method="post">
                                              {{ csrf_field() }}
                                              {{ method_field('put') }}
