                    ...
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        @foreach($investasi as $invest)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('proposal.project.investasi.download', $invest->id) }}" method="get">
                                      <button type="submit" class="btn btn-sm btn-block btn-primary mr-4">Download</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="{{ route('laporan.project.investasi.download', $invest->id) }}" method="get">
                                      <button type="submit" class="btn btn-sm btn-block btn-primary mr-4">Download</button>
                                    </form>
                                </td>
                                ...
                                <td>
                                    <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <form action="{{ route('project.investment.reject', $invest->id) }}" method="post">
                                              {{ csrf_field() }}
                                              {{ method_field('put') }}
