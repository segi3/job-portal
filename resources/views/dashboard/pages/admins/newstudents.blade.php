...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">New Students</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="card-title">New Students Table</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        @foreach($students as $student)
                            <tr>
                                ...
                                <td>{{ $student->email }}</td>
                                <td>
                                    <form action="{{ route('berkas.student.download', $student->id) }}" method="get">
