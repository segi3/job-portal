...
@section('title', 'Unapproved Project Investment')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Unapproved Project Investment</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item active">Manage-Investment</li>
            <li class="breadcrumb-item active">Unapproved- Project Investment</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="card-title">Unapproved Project Investment Table</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        @foreach($investasi as $invest)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-lg-6">
                                          <form action="{{ route('project.investment.approve', $invest->id) }}" method="post">
                                              {{ csrf_field() }}
                                              {{ method_field('put') }}
