...
@section('title', 'Create Project Invesment')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Create Project investment</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Manage-Investment</li>
                    <li class="breadcrumb-item active">Create-Project-Investment</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="container-fluid">
        <form method="POST" role="form" id="quickForm" enctype="multipart/form-data"
            action="{{ route('dashboard.investee.createProjectInvestment') }}">
            @csrf
            <div class="row">
                {{-- Deskripsi Investasi --}}
                    ...
                    <div class="card card-primary h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="totallembar" value="{{ old('totallembar') }}"
                                        class="form-control" id="inputprice" placeholder="Masukkan hanya nominal">
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="roi_d" value="{{ old('roi_d') }}"
                                                class="form-control" id="inputroid" placeholder="Batas ROI Bawah">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <input type="text" name="roi_u" value="{{ old('roi_u') }}"
                                                class="form-control" id="inputroiu" placeholder="Batas ROI Atas">
