                        ...
                        <table class="table table-bordered table-responsive-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="http://{{$mentoring->link}}" target="_blank">Link</a></td>
                                    <td>
                                        @if (empty($mentoring->dokumentasi))
                                        <form
                                            action="{{ route('iyt.mentoring.upload.dokumentasi', $mentoring->notulensi_id) }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <button type="submit"
                                                        style="border: 2px solid rgba(58, 133, 191, 0.75); border-radius: 40px;"
                                                        class="btn btn-sm btn-block btn-primary">Upload</button>
                                                </div>
                                        ...
                                        @else
                                        <form
                                            action="{{ route('iyt.mentoring.download.dokumentasi', $mentoring->notulensi_id) }}"
                                            method="get">
                                            {{ csrf_field() }}
                                            {{ method_field('get') }}
                                            <button type="submit" class="btn btn-sm btn-block btn-link"
                                                style="border: 2px solid; border-radius: 40px;">Download</button>
                                        </form>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-block btn-primary"
                                            style="border: 2px solid; border-radius: 40px;" data-toggle="modal"
                                            data-target="#modal2-{{ $mentoring->notulensi_id }}">
                                            Tambah Notulensi
                                        </button>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('iyt.postNotulensi', ['id' => $mentoring->notulensi_id]) }}"
                                                            method="post" id="postNotulensi">
                                                            {{ csrf_field() }}
                                                            {{ method_field('put') }}
                                                            <textarea name="notulensi" class="form-control"
                                                                id="inputNotulensi"></textarea>
                                        ...
                                        <button type="button" class="btn btn-sm btn-block btn-primary"
                                            style="border: 2px solid; border-radius: 40px;" data-toggle="modal"
                                            data-target="#modal3-{{ $mentoring->notulensi_id }}">
                                            Notulensi
                                        </button>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-block btn-primary"
                                            style="border: 2px solid; border-radius: 40px;" data-toggle="modal"
                                            data-target="#modal-{{ $mentoring->notulensi_id }}">
                                            Komentar
                                        </button>
