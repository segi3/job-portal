						...
						@csrf
                            ...
                            <div class="mt-10">
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="status" id="statusopt1" value="lajang">
                                    <label for="statusopt1" class="form-check-label">
                                        Lajang
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="status" id="statusopt2" value="menikah">
